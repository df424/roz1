...
Manages hardware-assisted clock synchronization between the controller and companion computer (R30). Uses the PAL input capture to timestamp sync pulses with cycle-accurate precision.
